...
namespace _3_GUI_PresentationLayer
{
    public partial class Frm_QuanLiNCC : Form
    {
        ...
        void LoadData()
        {
            ...
            dgv_NhaCungCap.Columns[2].Name = "Số Điện Thoại";
            ...
            {
                dgv_NhaCungCap.Rows.Add(x.MaNhaCungCap, x.TenNhaCungCap, x.SoDienThoai, x.DiaChi, x.TrangThai == 1 ? "Hoạt Động" : "Không Hoạt Động", x.TrangThai == 0 ? "Không Hoạt Động" : "Hoạt Động");
            }
        }
        ...
        private void dgv_NhaCungCap_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (rowindex >= _iServicesQLNhaCungCap.getLstNhaCungCaps().Count || rowindex < 0) return;
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_iServicesQLNhaCungCap.ThemNCC(ncc));
                LoadData();
                clearfrom();
            }
        }
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_iServicesQLNhaCungCap.SuaNCC(ncc));
                LoadData();
                clearfrom();
            }
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            dgv_NhaCungCap.Rows.Clear();
            if (_iServicesQLNhaCungCap.getLstNhaCungCaps().Count < 0) return;
            foreach (var x in _iServicesQLNhaCungCap.getLstNhaCungCaps().Where(c=>c.TenNhaCungCap.ToLower().StartsWith(txt_TenNcc.Text)))
            {
                dgv_NhaCungCap.Rows.Add(x.MaNhaCungCap, x.TenNhaCungCap, x.SoDienThoai, x.DiaChi, x.TrangThai == 1 ? "Hoạt Động" : "Không Hoạt Động", x.TrangThai == 0 ? "Không Hoạt Động" : "Hoạt Động");
            }
        }
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_iServicesQLNhaCungCap.saveNCC());
            }
        }
    }
}
